...
>
   ...
   <!--Don't need this because output is called in a PHP script that already has basic HTML structure.
   ...
   <xsl:template match="DOC">
    ...
    <xsl:template match="note">
       ...
       <xsl:choose> <xsl:when test="$attribute-value='instructor'">
            <sup>
                <a href="#" data-tooltip="K. Smith: {text()}" data-tooltip-position="bottom">[i.n.]</a>
